...
from state import (
    ...
    get_user_name, get_user_context_obj
)
...
async def handle_voice_message(message: Message):
    ...
    # Голосовые сообщения разрешены в состояниях:
    # - awaiting_question (когда пользователь задает вопрос)
    # - collecting_life_context (сбор контекста жизни)
    # - collecting_goal_context (сбор контекста цели)
    # - pretest_question (вопрос до теста)
    ...
    if current_state not in allowed_states:
        # Если не в нужном состоянии, проверяем, завершен ли тест
        ...
        # Если тест пройден, но не в состоянии вопроса, предлагаем нажать кнопку
