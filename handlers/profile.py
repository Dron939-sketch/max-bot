...
import logging
import asyncio
import time  # Добавлено для паузы между сообщениями
...
# ============================================
# ФУНКЦИЯ ДЛЯ РАЗБИВКИ ДЛИННЫХ СООБЩЕНИЙ (ДОБАВЛЕНА!)
# ============================================
...
def show_ai_profile(message: Message, user_id: int):
    ...
    try:
        ...
        if ai_profile:
            ...
            if len(ai_profile) > 3800:  # Немного меньше лимита для запаса
